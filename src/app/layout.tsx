...
export const metadata: Metadata = {
  title: "Alessandro Noya - Student Athlete & Future Pilot Portfolio",
  description: "Meet Alessandro Noya, a talented junior at Torrey Pines High School excelling in volleyball, chess, academics, and pursuing his pilot license. From Rio to Rome to San Diego.",
  keywords: ["Alessandro Noya", "Torrey Pines High School", "student athlete", "volleyball player", "chess prodigy", "pilot training", "San Diego student", "academic excellence"],
  metadataBase: new URL("https://alessandronoya.com"),
  alternates: {
    canonical: "https://alessandronoya.com"
  },
  openGraph: {
    title: "Alessandro Noya - Rising Star Portfolio",
    description: "Multi-talented student from Rio to Rome to San Diego, excelling in volleyball, chess, academics, and aviation",
    siteName: "Alessandro Noya",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763225563471-1irw6hz9.jpg",
  ...
  twitter: {
    ...
    title: "Alessandro Noya - Student Excellence Portfolio",
    description: "From Rio to Rome to San Diego - showcasing achievements in volleyball, chess, academics, and aviation",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763225563471-1irw6hz9.jpg"]
  },
  robots: {
    index: true,
    follow: true
